...
public class AnimationObject {
    ...
    private void Draw(double x, double y, double Angle, double Scale, double Alpha) {
        Engine.begin();
        Engine.drawPic(ImgSrc, (float) x, (float) y, (float) Angle, (float) Scale, (float) Scale, 1, 1, 1, (float) Alpha);
        Engine.end();
    }
